...
Um geom é o objeto geométrico que um gráfico usa para representar dados. Muitas vezes as pessoas descrevem plotagens pelo tipo de geom que a plotagem usa. Por exemplo, os gráficos de barras usam geoms de barra, gráficos de linha usam geoms de linha, boxplots usam geoms de boxplot e assim por diante. Os gráficos de dispersão quebram a tendência; eles usam o ponto geom. Como vimos acima, você pode usar diferentes geoms para plotar os mesmos dados. O gráfico à esquerda usa o ponto geom, e o gráfico à direita usa o geom suave, uma linha suave ajustada aos dados.

Para alterar o geom em seu gráfico, altere a função geom que você adiciona ggplot(). Por exemplo, para fazer os gráficos acima, você pode usar este código:
